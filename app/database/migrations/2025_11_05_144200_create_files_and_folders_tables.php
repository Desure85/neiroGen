...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Add foreign key using raw SQL for UUID compatibility
        DB::statement('ALTER TABLE files ADD CONSTRAINT files_parent_id_foreign FOREIGN KEY (parent_id) REFERENCES files(id) ON DELETE CASCADE');
