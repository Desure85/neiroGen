...
class UpdateExerciseTypeFieldRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $exerciseTypeField = $this->route('exerciseTypeField');
        ...
        return [
            ...
            'key' => [
                ...
                'max:255',
                'regex:/^[a-z0-9_]+$/',
                Rule::unique('exercise_type_fields', 'key')
                    ->where('exercise_type_id', $exerciseType?->id)
                    ->ignore($exerciseTypeField->id ?? null),
            ],
            'field_type' => ['sometimes', 'string', Rule::in([
                'string',
                'text',
                'integer',
                'number',
